    ...
    <section id="infrastructure" className="py-24 bg-slate-50 overflow-hidden">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex flex-col content-center w-full md:w-1/2 xl:w-1/4">
          ...
          <div className="flex w-full md:w-1/2 xl:w-3/4 content-center h-full overflow-hidden md:pb-4">
            <Image
              width={800}
              height={600}
