...
const Process = () => {
    ...
    return (
        <section id="process" className="py-24 bg-radial-[at_25%_25%] from-slate-50 to-slate-200 to-75% overflow-hidden">
            <div className="container max-w-7xl mx-auto px-6">p
                ...
                <ProcessClient />
                <div className="hidden gap-4 lg:gap-6">
                    <div>
                        <h3>1</h3>
                        <h4 className="text-lg md:text-xl lg:text-2xl">Request an Executive Site Briefing</h4>
                        <p>Whether it&apos;s a production facility or corporate headquarters, we&apos;ll help you find the perfect space</p>
                    </div>
                    <div>
                        <h3>2</h3>
                        <h4 className="text-lg md:text-xl lg:text-2xl">Zoning & Licensing</h4>
                    ...
                    <div>
                        <h3>3</h3>
                        <h4 className="text-lg md:text-xl lg:text-2xl">Start Construction</h4>
