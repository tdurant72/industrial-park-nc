      ...
      <AnimatePresence mode="wait">
        {!isOpen ? (
          <motion.button
            ...
            className="bg-amber-500 text-slate-950 px-6 py-4 rounded-full shadow-2xl border border-amber-600 flex items-center gap-3 group hover:bg-amber-400 transition-colors"
          >
          ...
          <motion.div
            ...
            className="bg-slate-950 border border-slate-800 w-[320px] rounded-4xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] overflow-hidden"
          >
            {/* Header */}
            <div className="p-6 pb-0 flex justify-between items-center">
              <h3 className="text-amber-500 font-extrabold uppercase tracking-[0.2em] text-sm">Get Started</h3>
              <button
            ...
            <div className="p-6">
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-4 mb-6">
                <div className="flex gap-4 items-center">
                  <div className="relative size-16 rounded-2xl overflow-hidden border-2 border-amber-500/30">
                    <Image
                      src="/images/ncgtp/jeremy-stroud.webp" // Placeholder for Bryn Covington
                      alt="Bryn Covington"
                      fill
                  ...
                  <div>
                    <h4 className="text-white font-bold text-lg">Bryn Covington</h4>
              ...
              <div className="space-y-3">
                <button
                  className="w-full bg-cyan-400/20 text-cyan-50 border border-cyan-400/30 py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-cyan-400 hover:text-slate-950 transition-all shadow-lg active:scale-[0.98]"
                >
                  Schedule a Meeting
                </button>
                <button
